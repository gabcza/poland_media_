...
```{r}
#trust_index correlation 
trust_dat <- cbind(dat_long$truthful, dat_long$trustworthy, dat_long$objective)

cor_mat <- cor(trust_dat)

colnames(cor_mat)<- c("truthful", "trustworthy", "objective")
rownames(cor_mat) <- c("truthful", "trustworthy", "objective")
